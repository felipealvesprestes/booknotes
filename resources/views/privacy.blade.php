...
<head>
    ...
    @php($metaDescription = 'Entenda como o ' . config('app.name') . ' trata dados pessoais, cookies e informações de acesso em conformidade com a LGPD.')
    @php($metaRobots = 'index,follow')
    @php($canonical = route('privacy'))
