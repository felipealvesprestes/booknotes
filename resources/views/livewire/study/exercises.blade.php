            ...
            <fieldset class="space-y-3">
                @foreach ($modeLabels as $modeKey => $label)
                    ...
                    <button
                        ...
                        @class([
                            'flex w-full cursor-pointer flex-col rounded-lg border px-4 py-3 text-left text-sm transition-all focus:outline-none focus-visible:outline-none',
                            'border-indigo-500 bg-indigo-50 text-indigo-900 shadow-none' => $isActive,
