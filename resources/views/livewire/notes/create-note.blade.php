                        ...
                        >
                            ...
                            >
                                ...
                                <div class="mt-6">
                                    <button
                                        type="button"
                                        class="inline-flex w-full justify-center rounded-md bg-emerald-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-500 focus-visible:outline focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:outline-none"
                                        x-on:click="closeModal()"
                                    >
                                        {{ __('Got it') }}
                                    </button>
