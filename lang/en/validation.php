...
return [
    ...
    */
    ...
    'custom' => [
        'flashcardQuestion' => [
            'required_if' => 'Add a flashcard question to create a flashcard.',
        ],
        'flashcardAnswer' => [
            'required_if' => 'Add the flashcard answer so you can review it later.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'pdfUpload' => 'PDF file',
        'pdfQuantity' => 'flashcard quantity',
